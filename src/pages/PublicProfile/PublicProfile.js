  ...
  renderProfileInfo =  () => {
    const state = this.props.location.state;
      return(
        <div>
          <Card
            className="publicProfilePageCard"
            cover={<img alt="userpic" className='publicProfileImg'  src={state.userImage || "https://zos.alipayobjects.com/rmsportal/ODTLcjxAfvqbxHnVXCYX.png"} />}
          >
            <Meta
              title= {(
                <div className="PublicProfileInfo">
                  <div clssName="profileInfo">
                    <h1> 
                      {state?.name} 
                    </h1>
                    <h4> 
